...
public class VRKeyboardManager : MonoBehaviour
{
	...
	public bool useRelativePlacement;
	...
	{		
		...
		if(useRelativePlacement)
			keyboard.gameObject.transform.position = localVRPlayerCamera.transform.position + relativePosition;

		AttachMarrets();

		leftBaseController.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor>().enabled = false;
		rightBaseController.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor>().enabled = false;
	...
	public void DisableVRKeyboard() 
	{
		...
		leftBaseController.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor>().enabled = true;
		rightBaseController.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor>().enabled = true;
