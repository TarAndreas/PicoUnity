...
public class GameManager : MonoBehaviour {
	...
	void Update () {
        ...
        if (Input.GetMouseButtonDown(0) && line.gameObject.activeSelf)
        {
            ...
            WhiteBall.GetComponent<Rigidbody>().linearVelocity = direction * 10f;
        }

        if (!line.gameObject.activeSelf && WhiteBall.GetComponent<Rigidbody>().linearVelocity.magnitude < 0.3f)
        {
